...
4. For every pixel:
   - Stop if it is outside the image.
   - Stop if its color is different from `original_color`.
5. Change the current pixel to the new `color`.
6. Recursively visit its four neighbors:
   - Down
   - Up
   - Right
   - Left
...
Due to the DFS recursion stack.
'''